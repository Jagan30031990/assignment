...
<meta name="csrf-token" content="{{ csrf_token() }}" />
			...
			<div class="card-body">
				...
				<div class="d-flex align-items-center">
					...
					<div class="position-relative w-md-400px me-md-2">
						...
						<input type="text" class="form-control form-control-solid ps-10 search_data"
							data-kt-repeater="tagify" id="search" name="search"	placeholder="Search" />
					</div>
					<!--end::Input group-->
					<!--begin:Action-->
					<div class="d-flex align-items-center">
						<button type="submit" class="btn btn-primary me-5 btn-submit">Search</button>
								...
								<div class="col-lg-6">
									...
									<div class="nav-group nav-group-fluid">
										...
										<label>
											...
											<span
												class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bolder px-4">Users</span>
										</label>
										<!--end::Option-->
										<!--begin::Option-->
										<label>
											...
											<span
												class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bolder px-4">Orders</span>
										</label>
										<!--end::Option-->
									</div>
									<!--end::Radio group-->
	...
	<div class="d-flex flex-wrap flex-stack pb-7">
		...
		<div class="d-flex flex-wrap align-items-center my-1">
			<h3 class="fw-bolder me-5 my-1">{{$count_of_data}} Items Found
				...
				<div class="card-body pt-0">
					...
					<div class="table-responsive table-responsive-common">
						...
						<table id="example"
							...
							style="border: none !important;" cellspacing="0" width="100%">
					...
					<div class="dt-more-container">
						<button id="btn-example-load-more" class="btn common_btn_one" style="display:none">Load
							More</button>
					</div>
				</div>
				<!--end::Card body-->
