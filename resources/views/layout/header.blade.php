...
<!--begin::Heading-->
<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background:#5b5bde;">
<!--begin::Title-->
<h3 class="text-white fw-bold">Quick Updates</h3>
<!--end::Title-->
...
<!--end::Svg Icon-->
<span class="fs-5 fw-bold text-gray-800 mb-0">Total Downloads</span>
<span class="fs-7 text-gray-400">800</span>
</a>
</div>
<!--end:Item-->
<!--begin:Item-->
...
<!--end::Svg Icon-->
<span class="fs-5 fw-bold text-gray-800 mb-0">Total Search</span>
<span class="fs-7 text-gray-400">900</span>
</a>
</div>
<!--end:Item-->
<!--begin:Item-->
...
<span class="fs-7 text-gray-400">8000</span>
</a>
</div>
<!--end:Item-->
<!--begin:Item-->
...
<span class="fs-7 text-gray-400">100</span>
</a>
</div>
<!--end:Item-->
</div>
...
@if ($user_data->profile_image)
    <img src="{{ asset('images/'.$user_data->profile_image) }}" alt="{{ $user_data->profile_image }}" />
@else 
    <img src="{{ asset('/assets/images/no-image.jpeg') }}" alt="{{ $user_data->profile_image }}" />
@endif
</div>
...
<div class="d-flex flex-column">
<div class="fw-bolder d-flex align-items-center fs-5">{{$user_data['name']}}
</div>
<a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{$user_data->email}}</a>
</div>
<!--end::Username-->
</div>
</div>
