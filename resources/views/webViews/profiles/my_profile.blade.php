...
<div id="kt_content_container" class="container-xxl">
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-header cursor-pointer">
										...
										<!--end::Card title-->
										<!--begin::Action-->
										<a href="{{route('webViews.profiles.edit_profile')}}" class="btn common_btn_one align-self-center">Edit Profile</a>
										<!--end::Action-->
									</div>
									<!--begin::Card header-->
									<!--begin::Card body-->
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 fv-row">
												<span class="fw-bold text-gray-800 fs-6">ajay.kumar@decor-masters.com</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800">Designation</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-10">
											...
											<!--begin::Label-->
											<div class="col-lg-8">
												<span class="fw-bold fs-6 text-gray-800">Akash</span>
											</div>
											<!--begin::Label-->
										</div>
										<!--end::Input group-->
