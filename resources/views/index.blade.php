		...
		<div class="card_box_common mb-7">
			...
			<div class="">
				...
				<div class="d-flex align-items-center">
                    ...
                    <!--begin:Action-->
                    <div class="d-flex align-items-center">
                    	<button type="submit" id="submit_search" class="btn btn-sm common_btn_one me-2" onclick="show_close();">Search</button>
    					...
    					<div class="card-header  align-items-center py-5 gap-2 gap-md-5">
    						...
    						<div class="card-title">
    							...
    							<div class="d-flex align-items-center position-relative">
    								...
    								<h3 class="fw-bolder me-5 my-1">Showing 1 to  of {{$count_of_data}} records
