...
<div id="kt_content_container" class="container-xxl">
				                ...
				                <!--begin::Navs-->
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
											...
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
												<a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{route('webViews.profiles.edit_profile')}}">Settings</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item mt-2">
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800">Aman Sachdeva</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Row-->
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 fv-row">
												<span class="fw-bold text-gray-800 fs-6">DECOR MASTERS LLP</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">DECOR MASTERS LLP.com</a>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8">
												<span class="fw-bolder fs-6 text-gray-800">India</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
